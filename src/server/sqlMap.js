...
var sqlMap = {
  ...
  update: {
    ...
    updateOutRecordWithBox:`update out_record o,box b set b.out_count = b.out_count - o.out_count where b.customer_id = o.customer_id and o.customer_id = ? and o.product_name= ? and o.out_count= ? and o.product_sku = ?`,
