...
var sqlMap = {
  query: {
    ...
    getProductByCompanyName: `SELECT * FROM product p,customer_info c  where p.customer_id=c.customer_id and p.customer_company = ?`,
    // 获取所有货品信息
    ...
    getBoxByCompanyName: `SELECT * FROM box b,customer_info c  where b.customer_id=c.customer_id and b.customer_company = ?`,
    // 获取所有 箱子 信息
  ...
  update: {
    ...
    updateOutRecordWithBox:`update out_record o,box b set b.out_count = b.out_count - o.out_count where b.customer_id = o.customer_id and b.out_time = o.out_time and o.customer_id = ? and o.product_name= ? and o.out_count= ? and o.product_sku = ? and b.out_time = ?`,
    updateOutRecordWithProduct:`update out_record o,product p set p.out_count = p.out_count - o.out_count where p.customer_id = o.customer_id and o.customer_id = ? and o.product_name= ? and o.out_count= ? and o.product_sku = ?`,
  },
};
